...
### Core Features TOC
- [git-pm Features - Complete Guide](#git-pm-features---complete-guide)
  - [📋 Feature Index](#-feature-index)
    - [Core Features TOC](#core-features-toc)
  - [Core Features](#core-features)
    - [Full Dependency Resolution](#full-dependency-resolution)
    - [Explicit Versioning](#explicit-versioning)
    - [Branch Auto-Resolution](#branch-auto-resolution)
  ...
  - [New Features (v0.2.0)](#new-features-v020)
    ...
    - [Local Override Discovery](#local-override-discovery)
    - [Path Resolution](#path-resolution)
  - [Feature Comparison](#feature-comparison)
    - [vs npm/yarn](#vs-npmyarn)
    - [vs pip](#vs-pip)
    - [vs git submodules](#vs-git-submodules)
